...
const Footer = () => {
  ...
  // TODO @ng look into react-multi-carousel
  // TODO @ng stylesheets or CSS modules or LESS?
  // TODO @ng proptypes
  return (
    <Layout.Footer style={{ textAlign: `center`, background: `#AB202B` }}>
      ...
      <Space size="large" direction="vertical">
        <div>
          <span>
            <Carousel responsive={carouselSettings}>
              <div>item 1</div>
              <div>item 2</div>
              <div>item 3</div>
            </Carousel>
        ...
        <div className="icons-list" style={{ marginTop: `100px` }}>
        ...
        <div className="copyright">
          © Kongkong Dog Rescue {new Date().getFullYear()} made by Fellow Dog Lovers ૮ˆﻌˆა
        </div>
      </Space>
    </Layout.Footer>
  );
